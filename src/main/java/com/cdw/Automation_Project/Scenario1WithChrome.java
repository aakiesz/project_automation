...
public class Scenario1WithChrome {
    ...
    public void test() {
        ...
        driver.findElement(By.id("email_address")).sendKeys("shu9878@gmail.com");
        driver.findElement(By.id("password")).sendKeys("password@123");
        driver.findElement(By.id("password-confirmation")).sendKeys("password@123");
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//span[text()='Create an Account'])[1]"))).click(); 
        ...
        driver.findElement(By.id("email")).sendKeys("shu9878@gmail.com");
